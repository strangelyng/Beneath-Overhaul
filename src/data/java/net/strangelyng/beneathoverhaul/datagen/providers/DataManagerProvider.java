...
/*
 * Mostly copied direct from https://github.com/TerraFirmaCraft/TerraFirmaCraft/blob/1.21.x/src/data/java/net/dries007/tfc/data/providers/DataManagerProvider.java
 */
...
public abstract class DataManagerProvider<T> implements DataProvider
{
    ...
    {
        add(BeneathOverhaul.rl(name.toLowerCase(Locale.ROOT)), value);
    }
